...
permalink: /notes/teleportationNotes.html
aside:
  toc: true
sidebar:
  nav: notes
...
<iframe src='https://gfycat.com/ifr/AromaticGiantAztecant' frameborder='0' scrolling='no' allowfullscreen width='640' height='404'></iframe>
...
Players are used to in-game locomotion mechanics. When given one, they often prefer to use the locomotion instead of moving their real body around. Moving ones legs takes effort! Far more than moving a finger tip. Moving their head around gives the player depth and parallax information that helps create presence, invites discovery/curiosity, and allows for more subtle and detailed world design. Moving ones feet through the world creates a sense of presence that is threatened by constant player teleportation. Designing a teleportation system that encourages players to move their feet (while not punishing them for choosing to teleport) is important. The carrot is better than the stick, in this case.
...
<iframe src='https://gfycat.com/ifr/FrankParallelBlackbuck' frameborder='0' scrolling='no' allowfullscreen width='640' height='404'></iframe>
